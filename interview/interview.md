...
### 18.golang 中的指针和unsafe包？golang指针退化，不支持类型转换和运算，需要使用借助unsafe包
### 19.golang sync.pool 临时对象池
### 20.golang struct 可以比较吗？引用类型不可比较？reflect.DeepEqual的比较？
### 21.golang context 包的用途？
### 22.golang select 的用途？
### 23.golang 中的空结构体？
### 24.golang 总的set？
### 25.golang 的编译过程？
### 26.golang runtime 了解多少？
### 27.golang 什么情况下会发生内存泄漏？Goroutinue泄露？
### 28.golang 协程退出？
